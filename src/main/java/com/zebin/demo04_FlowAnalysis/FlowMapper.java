...
public class FlowMapper extends Mapper<LongWritable, Text, LongWritable, FlowBean> {
    ...
    @Override
    protected void map(LongWritable key, Text value, Mapper<LongWritable, Text, LongWritable, FlowBean>.Context context) throws IOException, InterruptedException {
        ...
        context.write(this.longWritable, this.flowBean);
    }
}
